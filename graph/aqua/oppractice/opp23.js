...
var GenParser = function(precedence){
    ...
    this.parse = function(tokens){
        ...
        while(i < tokens.length){
            ...
            }else if(t1[0]==="op"&&t2[0]==="id"&&t3[0]==="op"&&stackPs[3][t1[1]]){//class 3
                //class 3
                var p1 = stackPs[3][t2[1]];
                var p2 = feedPs[lookahead[1]];
                if(p1>p2){//reduce
                    stack.push(["id",[t1[1],t2]]);
                    continue;
                }
            }else if(t2[0]==="op"&&t3[0]==="id"&&stackPs[0][t2[1]]){//class 0
                //class 0
            ...
            }else if(t2[0]==="id"&&t3[0]==="op"&&stackPs[1][t3[1]]){//class 1
                //class 1
                var p1 = stackPs[1][t2[1]];
                var p2 = feedPs[lookahead[1]];
                if(p1>p2){//reduce
                    stack.push(t1);
    ...
    this.parseOrdered = function(tokens){
        ...
        while(i < tokens.length+1){
            ...
            if(t1[0]==="id"&&t2[0]==="op"&&t3[0]==="id"&&stackPs[2][t2[1]]){//class 2
                ...
                var p1 = stackPs[2][t2[1]];
                var p2 = feedPs[lookahead[1]];
                console.log(t1,t2,t3,lookahead);
                if(p1>p2){//reduce
            ...
            if(t1[0]==="op"&&t2[0]==="id"&&t3[0]==="op"&&stackPs[3][t1[1]]){//class 3
                //class 3
                var p1 = stackPs[3][t1[1]];
                var p2 = feedPs[lookahead[1]];
                if(p1>p2){//reduce
                    console.log(t1,t2,t3);
                    stack.push(["id",[t1,t2,t3]]);
